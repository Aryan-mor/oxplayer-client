...
///
/// This file intentionally mutates persisted JSON as maps and primitives only.
/// Do not import `dart:io`, `path_provider`, `AccountModel`, Freezed models, or
/// Riverpod providers here; DDC must not discover the native persistence graph.
